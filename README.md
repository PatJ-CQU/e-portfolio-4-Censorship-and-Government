...
### Summary
This article is by the e-safety commission. It contains the laws made based on the e-safety commissioners recommendations. These laws are centred around which social media platforms are excluded from the age restrictions. From this article I learned that the reason for the social media restriction is to as stated by the eSafety Commissioner (2026) the purpose is to: "ensure people can use their services safely, consider the best interests of the child in the design and operation of services likely to be accessed by children
prevent children’s access to age-inappropriate restricted material such as pornography." This is relevant to society as this effects the new generation and what they view on the internet. 
